                                    ...
                                    <table class="table table-bordered table-sm survey">
                                        ...
                                        <tbody>
                                                    ...
                                                    @if ($data->check_p3)
                                                        <ul>
                                                            @foreach($supliers as $suplier)
                                                                <li>{{ $suplier->namaSuplier }}, {{ $suplier->negara }}, {{ $suplier->tanggal }}, {{ $suplier->jumlah.' MT' }}</li>
                                                            @endforeach
                                                        </ul>
                                                    @else
                                                        -
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($data->P7)
                                                        <div><b>Jumlah:</b> {{ $data->P7_1 ? $data->P7_1 : '-' }}</div>
                                                        <div><b>Kapasitas:</b> {{ $data->P7_2 ? $data->P7_2 : '-' }}</div>
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($data->P8)
                                                        <div><b>Pemisahan ruangan antar produk:</b> {{ $data->P8_1 ? $data->P8_1 : '-' }}</div>
                                                        <div><b>Lokasi antar produk terpisah:</b> {{ $data->P8_2 ? $data->P8_2 : '-' }}</div>
                                                        <div><b>Partisi antar produk:</b> {{ $data->P8_3 ? $data->P8_3 : '-' }}</div>
                                                        <div><b>Perlatan terpisah:</b> {{ $data->P8_4 ? $data->P8_4 : '-' }}</div>
                                                    @else
                                                        -
                                                    @endif
                                                </td>
