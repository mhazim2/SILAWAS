        ...
        <div class="col-lg-2">\
            <div class="form-group">\
                ...
                <div class="input-group mb-3">\
                    <input type="text" class="form-control" name="P3_5[]">\
...
function clear_p7(){
    ...
    document.getElementById('p7_3_ket').checked = false;
    document.getElementById('p7_4_ket').checked = false;
}
...
function clear_p9(){
    document.getElementById('p9_ket_1_1').checked = false;
    document.getElementById('p9_ket_1_2').checked = false;
    document.getElementById('p9_ket_2_1').checked = false;
    document.getElementById('p9_ket_2_2').checked = false;
    document.getElementById('p9_ket_3_1').checked = false;
    document.getElementById('p9_ket_3_2').checked = false;
    document.getElementById('p9_ket_4').value = null;
}
...
function check_p10() {
    if(document.getElementById('p10_1').checked) {
        ...
        var count_input = document.getElementById('hidden_p10').getElementsByTagName('input').length;
        for (var i=0; i<count_input; i++) document.getElementById('hidden_p10').getElementsByTagName('input')[i].value=null;
    }
}
...
function clear_p11(){
    document.getElementById('p11_ket_1_1').checked = false;
    document.getElementById('p11_ket_1_2').checked = false;
    document.getElementById('p11_ket_2').value = null;
    document.getElementById('p11_ket_3').value = null;
    document.getElementById('p11_ket_4_1').checked = false;
    document.getElementById('p11_ket_4_2').checked = false;
}
...
function clear_p13(){
    document.getElementById('p13_ket_1_1').checked = false;
    document.getElementById('p13_ket_1_2').checked = false;
    document.getElementById('p13_ket_2_1').checked = false;
    document.getElementById('p13_ket_2_2').checked = false;
    document.getElementById('p13_ket_3').value = null;
    document.getElementById('p13_ket_4').value = null;
    document.getElementById('p13_ket_5_1').checked = false;
    document.getElementById('p13_ket_5_2').checked = false;
}
...
function clear_p14(){
    ...
    document.getElementById('p14_ket_2').value = null;
}
