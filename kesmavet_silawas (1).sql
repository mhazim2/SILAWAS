...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2019 at 05:54 AM
...
CREATE TABLE `unitusaha` (
  ...
  `NamaKantorPusat` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `orang`
  MODIFY `idOrang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
