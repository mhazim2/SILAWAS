...
@section('content')
    <section class="page-content py-5">
        <div class="container">
            <div class="detail-laporan p-3">
                <h3 class="font-weight-bold text-center text-kesmavet">
                    Judul 1
                </h3>
                <img class="laporan-cover" src="https://picsum.photos/600/400" alt="Gambar Laporan">
