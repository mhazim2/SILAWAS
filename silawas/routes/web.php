...
// Halaman Utama
Route::get('/silawas', 'HomeController@index')->name('home')->where('name', '|home');
...
// Halaman Checklist 1
Route::redirect('/silawas/pengawasan/checklist/1', '/pengawasan/checklist/1/umum')->name('checklist1.show');
...
// Halaman Checklist 2
Route::redirect('/silawas/pengawasan/checklist/2', '/pengawasan/checklist/2/umum')->name('checklist2.show');
...
// Halaman Checklist 3
Route::redirect('/silawas/pengawasan/checklist/3', '/pengawasan/checklist/3/umum')->name('checklist3.show');
...
// Halaman Checklist 4
Route::redirect('/silawas/pengawasan/checklist/4', '/pengawasan/checklist/4/umum')->name('checklist4.show');
...
// Halaman Checklist 5
Route::redirect('/silawas/pengawasan/checklist/5', '/pengawasan/checklist/5/umum')->name('checklist5.show');
...
// Halaman Checklist 6
Route::redirect('/silawas/pengawasan/checklist/6', '/pengawasan/checklist/6/umum')->name('checklist6.show');
...
// Halaman Checklist 7
Route::redirect('/silawas/pengawasan/checklist/7', '/pengawasan/checklist/7/umum')->name('checklist7.show');
...
// Halaman Checklist 8
Route::redirect('/silawas/pengawasan/checklist/8', '/pengawasan/checklist/8/umum')->name('checklist8.show');
...
// Halaman Checklist 9
Route::redirect('/silawas/pengawasan/checklist/9', '/pengawasan/checklist/9/umum')->name('checklist9.show');
...
Route::redirect('/silawas/pengawasan/checklist/10', '/pengawasan/checklist/10/umum')->name('checklist10.show');
...
Route::redirect('/silawas/pengawasan/checklist/11', '/pengawasan/checklist/11/umum')->name('checklist11.show');
...
Route::redirect('/silawas/pengawasan/checklist/12', '/pengawasan/checklist/12/umum')->name('checklist12.show');
...
Route::redirect('/silawas/pengawasan/checklist/13', '/pengawasan/checklist/13/umum')->name('checklist13.show');
...
Route::redirect('/silawas/pengawasan/checklist/14', '/pengawasan/checklist/14/umum')->name('checklist14.show');
