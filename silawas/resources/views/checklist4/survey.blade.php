                                            ...
                                            <div id="hidden_p4_2" class="bg-kesmavet p-2 mt-2 mb-4" style="display:none">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-2">
                                                            <label>Keterangan</label>
                                                            <textarea class="form-control" rows="2" name="P4_4"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="hidden_p5_1" class="bg-kesmavet p-2 mt-2 mb-4" style="display:none">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="hidden" id="p5_count" name="P5_1" value="0">
                                                        <div id="hidden_p5_1_detail" class="px-2"></div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea class="form-control" rows="2" name="P7_1"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-8">
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control" name="P7_2">
                                                                        <div class="input-group-append">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="d-block">
                                                                <div class="icheck-white d-inline mr-3">
                                                                    <input id="p8_2_1" type="radio" name="P8_2" value="Ada">
                                                                    <label class="font-weight-normal" for="p8_2_1">Ada</label>
                                                                </div>
                                                                <div class="icheck-white d-inline">
                                                                    <input id="p8_2_2" type="radio" name="P8_2" value="Tidak Ada">
                                                                    <label class="font-weight-normal" for="p8_2_2">Tidak Ada</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="d-block">
                                                                <div class="icheck-white d-inline mr-3">
                                                                    <input id="p8_3_1" type="radio" name="P8_3" value="Ada">
                                                                    <label class="font-weight-normal" for="p8_3_1">Ada</label>
                                                                </div>
                                                                <div class="icheck-white d-inline">
                                                                    <input id="p8_3_2" type="radio" name="P8_3" value="Tidak Ada">
                                                                    <label class="font-weight-normal" for="p8_3_2">Tidak Ada</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="d-block">
                                                                <div class="icheck-white d-inline mr-3">
                                                                    <input id="p8_4_1" type="radio" name="P8_4" value="Ada">
                                                                    <label class="font-weight-normal" for="p8_4_1">Ada</label>
                                                                </div>
                                                                <div class="icheck-white d-inline">
                                                                    <input id="p8_4_2" type="radio" name="P8_4" value="Tidak Ada">
                                                                    <label class="font-weight-normal" for="p8_4_2">Tidak Ada</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="d-block">
                                                                <div class="icheck-white d-inline mr-3">
                                                                    <input id="p8_5_1" type="radio" name="P8_5" value="Ada">
                                                                    <label class="font-weight-normal" for="p8_5_1">Ada</label>
                                                                </div>
                                                                <div class="icheck-white d-inline">
                                                                    <input id="p8_5_2" type="radio" name="P8_5" value="Tidak Ada">
                                                                    <label class="font-weight-normal" for="p8_5_2">Tidak Ada</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <div class="d-block">
                                                                <div class="icheck-white d-inline mr-3">
                                                                    <input id="p8_6_1" type="radio" name="P8_6" value="Ya">
                                                                    <label class="font-weight-normal" for="p8_6_1">Ya</label>
                                                                </div>
                                                                <div class="icheck-white d-inline">
                                                                    <input id="p8_6_2" type="radio" name="P8_6" value="Tidak">
                                                                    <label class="font-weight-normal" for="p8_6_2">Tidak</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div id="hidden_p9" class="bg-kesmavet p-2 mt-2 mb-4" style="display:none">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-2">
                                                            <label>Bagaimana perlakuan terhadap telur yang retak/pecah?</label>
