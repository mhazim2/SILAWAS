...
(65, 'Wawan Setyadi', 'Jakarta', '1997-07-08', '32708012345', '081234567890', '1234567654321'),
(67, 'Alifka Aditya', NULL, NULL, NULL, '08123546813', NULL),
(68, 'Rachman Hakim', NULL, NULL, NULL, '09876436134', NULL),
(69, 'Prameswara', NULL, NULL, NULL, '08321654987', NULL);
...
INSERT INTO `pengawaskesmavet` (`idPengawasKesmavet`, `idUser`, `TMT`, `NoSK`, `PNS_idPegawai`, `idWilayahKerja`, `idRegencyCity`, `isActive`) VALUES
(1, 71, '2019-08-31', '123456789', 321, 8, 179, 1),
(2, 72, '2019-08-31', '8736541778821', 12345, 4, 227, 0),
(3, 73, '2019-08-31', '83785625731', 257, 1, 1, 0);
...
(1, NULL, 1, 'SuperFarm', 'Bogor', 'Bogor', '08123456789', '54321', 'cs@superfarm.com', 'Feby', '081987654321', '2019'),
(2, NULL, 49, 'Antinite', 'Jakarta', 'Jakarta', '089887654321', '456654', 'support@antinite.com', 'Alin', '08675432151', '2019'),
(5, NULL, 46, 'Megalodon', 'Bandung', 'Bandung', '08123454321', '76543', 'cs@megalodon.id', 'Wira', '081534567823', '2019');
...
(68, 'kunco3', '$2y$10$EKATAolMGiSLZ/Sp9h7N0.NG2lNaY3KLsbs0kQQ4pzzP.oEttQyHO', '123', NULL, 10, NULL, 'kucnoi3@mail.com', 7, '2019-08-27 15:56:26', '2019-08-27 15:56:26', 64),
(69, 'OneStyd', '$2y$10$RVTfecT3PbtmRcKdhyNRdOqUmJwoWYALSmCKT54I0gOj.kjosL3ou', '123', NULL, 10, NULL, 'wawansetyadi@gmail.com', 1, '2019-08-31 04:17:53', '2019-08-31 04:17:53', 65),
(71, 'alkadtra', '$2y$10$JxO4FQnubUpuPs63cSEIneu/m1NCDuBquG96gSOJJaFtw8Wc694vG', '123', NULL, 10, NULL, 'alifka@gmail.com', 7, '2019-08-31 19:10:30', '2019-08-31 19:10:30', 67),
(72, 'hacim', '$2y$10$VWXYX8wyb63oboOhchxEsenuogHspNyjdP4mMiKS/kVoMAk8np32K', '123', NULL, 10, NULL, 'hacim@gmail.com', 7, '2019-08-31 19:23:52', '2019-08-31 19:23:52', 68),
(73, 'prames', '$2y$10$K6RM4eDXVY.eFpEIprokre2nX5ESIJiY7LoJ7yCjTnbpCypp1cozm', '123', NULL, 10, NULL, 'prames@gmail.com', 7, '2019-08-31 19:49:18', '2019-08-31 19:49:18', 69);
...
--
ALTER TABLE `orang`
  MODIFY `idOrang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;

--
-- AUTO_INCREMENT for table `pengawaskesmavet`
--
ALTER TABLE `pengawaskesmavet`
  MODIFY `idPengawasKesmavet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
