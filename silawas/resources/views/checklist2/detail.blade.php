                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <table class="table table-inner table-borderless table-sm mb-0">
                                                        <tr>
                                                            @if ($data->form2->P1_1_1)
                                                                <td><b>No:</b> {{ $data->form2->P1_1_1 }}{!! $data->form2->P1_1_2 ? ', <b>Tanggal:</b> '.$data->form2->P1_1_2 !!}</td>
                                                            @else
                                                                <td>-</td>
                                                            @endif
                                                        </tr>
                                                        <tr>
                                                            @if ($data->form2->P1_2_1)
                                                                <td><b>No:</b> {{ $data->form2->P1_2_1 }}{!! $data->form2->P1_2_2 ? ', <b>Tanggal:</b> '.$data->form2->P1_2_2 !!}</td>
                                                            @else
                                                                <td>-</td>
                                                            @endif
                                                        </tr>
                                                        <tr>
                                                            @if ($data->form2->P1_3_1)
                                                                <td><b>No:</b> {{ $data->form2->P1_3_1 }}{!! $data->form2->P1_3_2 ? ', <b>Tanggal:</b> '.$data->form2->P1_3_2 !!}</td>
                                                            @else
                                                                <td>-</td>
                                                            @endif
                                                        </tr>
